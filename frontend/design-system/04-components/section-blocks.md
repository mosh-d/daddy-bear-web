...
The difference from Black Market: **two tones, not four**, restrained per `01-color.md`, and no section is racing the reader with a countdown or a "the record has never been broken" urgency device. The rhythm is the same; the register is Daddy Bear's own.
